        ...
        <SideBarInnerTop>
          <NavLink exact to="/" style={{ textDecoration: "none" }}>
            <Frame>
              ...
              <FrameText>Dashboard</FrameText>
            </Frame>
          </NavLink>
          <NavLink exact to="/activity" style={{ textDecoration: "none" }}>
            <Frame>
              <svg
                width="24"
                height="24"
              ...
              <FrameText>Activity</FrameText>
            </Frame>
          </NavLink>
          <NavLink exact to="/library" style={{ textDecoration: "none" }}>
            <Frame>
              <svg
                width="24"
                height="24"
              ...
              <FrameText>Library</FrameText>
            </Frame>
          </NavLink>
        </SideBarInnerTop>
        <SideBarBottom>
          <NavLink exact to="/settings" style={{ textDecoration: "none" }}>
            <Frame>
              <svg
                width="24"
                height="24"
